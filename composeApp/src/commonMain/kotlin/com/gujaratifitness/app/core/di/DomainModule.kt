...
import com.gujaratifitness.app.domain.usecases.*
...
val domainModule = module {
    ...
    factory { GenerateWorkoutPlanUseCase(get()) }
    factory { GenerateDietPlanUseCase(get()) }
    factory { DetectMuscleImbalanceUseCase(get()) }
    factory { GetSTierExercisesUseCase(get()) }
    factory { ManageInfluencerGroupUseCase(get()) }

    // Screen Models (now injected with use cases)
